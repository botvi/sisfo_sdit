                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit Kepala Sekolah</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="card-body p-5">
                            ...
                            <form action="{{ route('kepala-sekolah.update', $kepalaSekolah->id) }}" method="POST" class="row g-3" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="nama" name="nama_kepala_sekolah" value="{{ old('nama_kepala_sekolah', $kepalaSekolah->nama_kepala_sekolah) }}" required>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="nuptk" name="nuptk" value="{{ old('nuptk', $kepalaSekolah->nuptk) }}" required>
                                    <small class="text-danger">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="nip" name="nip" value="{{ old('nip', $kepalaSekolah->nip) }}" required>
                                    <small class="text-danger">
