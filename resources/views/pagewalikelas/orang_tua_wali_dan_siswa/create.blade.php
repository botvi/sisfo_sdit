                                ...
                                <div class="card-body p-5">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" class="form-control" id="nik_ibu" name="nik_ibu" minlength="16" maxlength="16" required>
                                            <small class="text-danger">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" class="form-control" id="nik_ayah" name="nik_ayah" minlength="16" maxlength="16" required>
                                            <small class="text-danger">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="number" minlength="10" maxlength="13" class="form-control" id="no_wa_ortu" name="no_wa_ortu" required>
                                            <small class="text-danger">
                                ...
                                <div class="card-body p-5">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" minlength="16" maxlength="16" class="form-control" id="nik_wali" name="nik_wali">
                                            <small class="text-danger">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="number" minlength="10" maxlength="13" class="form-control" id="no_wa_wali" name="no_wa_wali">
                                            <small class="text-danger">
                                ...
                                <div class="card-body p-5">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" id="master_kelas_id" name="master_kelas_id" required>
                                                ...
                                                @foreach($masterKelas as $kelas)
                                                    <option value="{{ $kelas->id }}">Kelas {{ $kelas->kelas }}</option>
                                                @endforeach
                                            </select>
                                            <small class="text-danger">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" minlength="10" maxlength="10" class="form-control" id="nisn" name="nisn" required>
                                            <small class="text-danger">
