                        ...
                        <table id="example2" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ \Illuminate\Support\Str::limit(strip_tags($data->konten_pengumuman), 100) }}</td>
                                    <td><img src="{{ asset('pengumuman/' . $data->gambar_pengumuman) }}" alt="Gambar Pengumuman" width="100"></td>
                                    <td>
                                      
                                        <a href="{{ route('pengumuman.show', $data->id) }}" class="btn btn-sm btn-info">
                                            <i class="bx bx-share-alt"></i> Detail dan bagikan
                                        </a>
                                        <a href="{{ route('master-pengumuman.edit', $data->id) }}" class="btn btn-sm btn-warning">Edit</a>
                                        <form action="{{ route('master-pengumuman.destroy', $data->id) }}" method="POST" style="display:inline;" class="delete-form">
                                            @csrf
                                            @method('DELETE')
