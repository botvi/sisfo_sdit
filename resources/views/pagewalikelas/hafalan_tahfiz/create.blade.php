                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Tambah Hafalan Tahfiz</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Tambah Hafalan Tahfiz</h5>
                            </div>
                            <hr>
                            <form action="{{ route('hafalan-tahfiz.store') }}" method="POST" class="row g-3" enctype="multipart/form-data">
                                @csrf
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="date" class="form-control" id="tanggal_hafalan" name="tanggal_hafalan" required>
                                    <small class="text-danger">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea rows="5" class="form-control" id="keterangan" name="keterangan" required></textarea>
                                    <small class="text-danger">
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary px-5"><i class='bx bx-save me-1'></i> Simpan dan Kirim Notifikasi</button>
                                </div>
                            </form>
                        </div>
                    </div>
