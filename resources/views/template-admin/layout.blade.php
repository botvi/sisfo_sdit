...
<head>
    ...
    @yield('style')
    <title>Dashboard - PONDOK PESANTREN MARKAZUL QUR'AN WASSUNAH</title>
</head>
...
<body>
    ...
    <div class="wrapper">
        ...
        <footer class="page-footer">
            ...
            <p class="mb-0">Copyright © <?php echo $year; ?>. PONDOK PESANTREN MARKAZUL QUR'AN WASSUNAH. All right
                reserved.</p>
        </footer>
    </div>
    <!--end wrapper-->
