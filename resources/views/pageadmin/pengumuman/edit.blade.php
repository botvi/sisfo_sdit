                            ...
                            <form action="{{ route('pengumuman.update', $pengumuman->id) }}" method="POST" class="row g-3"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="nama_pengumuman" name="nama_pengumuman"
                                        value="{{ old('nama_pengumuman', $pengumuman->nama_pengumuman) }}" required>
                                    <small class="text-danger">
                                        @foreach ($errors->get('nama_pengumuman') as $error)
                                            <li>{{ $error }}</li>
                                        @endforeach
                                    </small>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <select class="form-control" id="jenis_pengumuman" name="jenis_pengumuman" required>
                                        ...
                                        <option value="pengumuman" {{ old('jenis_pengumuman', $pengumuman->jenis_pengumuman) == 'pengumuman' ? 'selected' : '' }}>Pengumuman</option>
                                        <option value="berita" {{ old('jenis_pengumuman', $pengumuman->jenis_pengumuman) == 'berita' ? 'selected' : '' }}>Berita</option>
                                        <option value="event" {{ old('jenis_pengumuman', $pengumuman->jenis_pengumuman) == 'event' ? 'selected' : '' }}>Event</option>
                                    </select>
                                    <small class="text-danger">
                                        @foreach ($errors->get('jenis_pengumumun') as $error)
                                            <li>{{ $error }}</li>
                                        @endforeach
                                    </small>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <textarea id="konten_pengumuman" name="konten_pengumuman">{{ old('konten_pengumuman', $pengumuman->konten_pengumuman) }}</textarea>
                                    <small class="text-danger">
